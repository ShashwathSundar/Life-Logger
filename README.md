...
There is also a text field for custom entry, incase you want to update an activity that does not have a button for it yet.
<hr>
The list of buttons can be changed in a separate button list sheet.</br>
This is possible because the buttons are being dynamically created using JS.</p>
